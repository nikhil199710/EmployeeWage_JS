...
try
{
    ...
    let employeePayrollData= new  EmployeePayrollData(1,"Mark",30000,'M',new Date(),343434,'nikhil.ydv@capgemini.com');
    ...
    let newEmployeePayrollData= new EmployeePayrollData(1,"Teresa",25000,"F",new Date(),222222,'nit.ydvcapg.com');
